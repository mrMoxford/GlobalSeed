    ...
    <nav className={style.primaryNav}>
      <Link className={style.link} href="/">
        <Image
          ...
          src={Logo}
          alt="global-seed logo"
          height="50"
          width="auto"
        ></Image>
      </Link>
      <ul className={style.navList}>
        <Link className={pathname === "/" ? style.active : style.link} href="/">
          {" "}
          Home
        </Link>
        <Link
          className={pathname === "/#about" ? style.active : style.link}
          href="/#about"
        >
          {" "}
          About
        ...
        <Link
          className={pathname === "/programs" ? style.active : style.link}
          href="/programs"
        >
          {" "}
          Programs
        ...
        <Link
          className={pathname === "/study-abroad" ? style.active : style.link}
          href="/study-abroad"
        >
          {" "}
          Study Abroad
        ...
        <Link
          className={pathname == "/contact" ? style.active : style.link}
          href="/contact"
        >
          {" "}
          Contact
      ...
      {menuToggle && (
        <div className={style.navbar_overlay}>
          ...
          <ul className={style.toggleNav}>
            <Link onClick={handleNavLink} className={style.link} href="/">
              {" "}
              Home
            </Link>
            <Link onClick={handleNavLink} className={style.link} href="/#about">
              {" "}
              About
            </Link>
            <Link
            ...
            <Link
              onClick={handleNavLink}
              className={style.link}
              href="https://app.jibun-apps.jp/form/6c99f0e1-88ee-4f79-ad95-6d1f329c5d7d/new"
            >
              {" "}
              Contact
            </Link>
